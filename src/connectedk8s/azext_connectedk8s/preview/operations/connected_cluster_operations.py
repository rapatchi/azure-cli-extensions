...
class ConnectedClusterOperations(object):
    ...
    def list_cluster_user_credentials(
            self, resource_group_name, cluster_name, authentication_method, client_proxy, custom_headers=None, raw=False, **operation_config):
        ...
        print('printing from the preview sdk')
        # Construct URL
